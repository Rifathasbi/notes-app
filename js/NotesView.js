    ...
    constructor(root, { onNoteSelect, onNoteAdd, onNoteEdit, onNoteDelete } = {}) {
        ...
        this.root.innerHTML = `
            <div class="notes_sidebar">
                <button class="notes_add" type="button">Add New Notes</button>
                <div class="notes_list"></div>
            </div>
            <div class="notes_preview">
                <input class="notes_title" type="text" placeholder="notes...">
                <textarea class="notes_body">Take Notes...</textarea>
            </div>
        `;
